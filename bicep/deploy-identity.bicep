...
var containerRegistryPullIdentityName = toLower(take('id-acrpull-${nameSeedSafe}', 128))
...
// Dedicated identity shared by the Container Apps only for pulling images.
// Keeping it separate prevents the frontend from inheriting backend data-plane access.
...
output containerRegistryPullIdentityResourceId string = containerRegistryPullIdentity.id
